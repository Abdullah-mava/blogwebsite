...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>The Ultimate Guide to Choosing the Perfect Bike</title>
        <meta name="description" content="Find the perfect bike for you with our comprehensive guide on cycling options, styles, and tips." />
      ...
      <div id="home-section" className="relative w-full h-screen text-white">
        ...
        <div className="absolute inset-0 -z-10">
          <video 
            src="/bike-home.mp4" // Ensure this file is in the "public" folder
            autoPlay 
            loop 
            muted 
            playsInline 
