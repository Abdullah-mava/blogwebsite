      ...
      <div className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-start gap-8 mt-8">
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            Join us on this journey, and lets ride together toward knowledge and adventure! 🚴‍♀️
            </p>
          </div>
          <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          🚴‍♀️ Adventure –Whether you are looking for buying guides, cycling tips, or the latest biking trends, we have got you covered!
          ...
          Join us in celebrating the joy of biking! Let us ride towards a better, healthier, and more adventurous future together.
            </p>
          </div>
        </div>
      </div>
